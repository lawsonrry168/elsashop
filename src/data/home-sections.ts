...
export const HOME_SECTION_REGISTRY: Record<HomeSectionId, HomeSectionDefinition> = {
  ...
  "men-care": {
    ...
    defaults: {
      eyebrow: "Men's Care",
      title: "男賓護理專區",
      body: "針清、激光脫墨脫疣、深層清潔 — 獨立入口、私密舒服。",
      highlight: "單次收費",
      image: promo.menFacial.src,
      imageAlt: promo.menFacial.alt,
      linkLabel: "了解男賓療程",
      linkHref: "/men",
    },
  },
  wellness: {
    ...
    defaults: {
      eyebrow: "Wellness",
      title: "痛症理療 · 遠紅外線養生",
      body: "Dr. Rainbow 醫療級遠紅外線焗倉、Dr. Face 童顏機，配退背、拔罐、刮痧等傳統理療。做完 Facial 再焗一焗，由內到外排濕調理。",
      linkLabel: "了解痛症理療",
      linkHref: "/wellness",
    },
  },
